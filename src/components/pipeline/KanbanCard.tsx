    ...
    <Draggable draggableId={client.id} index={index}>
      {(provided, snapshot) => (
        <div
          ...
          } ${snapshot.isDragging ? "shadow-xl ring-2 ring-primary/30 rotate-2 scale-105" : ""} ${compact ? "p-2" : "p-3 space-y-2"}`}
        >
          {compact ? (
            /* ── COMPACT CARD ── */
            <div className="flex items-center gap-2">
              ...
              <span className="text-[9px] text-muted-foreground font-mono">{client.lead_score}</span>
